...
default_param<-list(
        ...
        gamma=0,
        max_depth=2, #default=6, original=3
        min_child_weight=3, #default=1, original=4
        subsample=1,
        colsample_bytree=1
)
```
...
xgb_mod <- xgb.train(data = dtrain, params=default_param, nrounds = 510)  # TODO: fix optimized nrounds
```
